...
object LocalizationKeys {
    ...
    const val MENU_WARP_MANAGEMENT_ACCESS_NAME_GLOBAL = "menu.warp_management.access.name.global"
    ...
    const val MENU_WARP_MANAGEMENT_ACCESS_LORE_GLOBAL = "menu.warp_management.access.lore.global"
